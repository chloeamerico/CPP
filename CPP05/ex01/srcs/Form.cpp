...
/*   Updated: 2025/12/29 11:43:33 by camerico         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string name, const int required_grade_to_sign, const int required_grade_to_execute) : _name(name), _is_signed(0),
...
void Form::beSigned(const Bureaucrat & bureaucrat)	//change le status de is_signed
{
