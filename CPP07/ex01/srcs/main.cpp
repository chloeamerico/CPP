...
/*   Updated: 2026/01/05 15:52:49 by camerico         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	size_t length1 = sizeof(tab1) / sizeof(tab1[0]);
	
	std::cout << "------ TEST INT------" << std::endl;
	std::cout << "test avant d'incementer :";
	iter(tab1, length1, afficher<int>);
	iter(tab1, length1, increment<int>);
	...
	size_t length2 = sizeof(tab2) / sizeof(tab2[0]);
	
	std::cout << "------ TEST DOUBLE------" << std::endl;
	std::cout << "test avant d'incementer :";
	iter(tab2, length2, afficher<double>);
	iter(tab2, length2, increment<double>);
	std::cout << std::endl << "test apres d'incementer :";
	iter(tab2, length2, afficher<double>);
	...
	size_t length3 = sizeof(tab3) / sizeof(tab3[0]);
	
	std::cout << "------ TEST CHAR------" << std::endl;
	std::cout << "test avant d'incementer :";
	iter(tab3, length3, afficher<char>);
	iter(tab3, length3, increment<char>);
	std::cout << std::endl << "test apres d'incementer :";
	iter(tab3, length3, afficher<char>);
